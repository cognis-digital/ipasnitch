#!/usr/bin/env sh
# Universal installer for ipasnitch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ipasnitch.git"
echo "Installing ipasnitch ..."
