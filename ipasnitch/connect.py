"""Native cognis-connect emit for ipasnitch — forward findings to any platform.

Maps ipasnitch's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    ipasnitch ... --format json | ipasnitch-emit --to stix
    ipasnitch-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
